<template>
    <div class="game-card">
        ...
        <div class="game-footer">
            ...
            <!-- Mode gestion-location -->
            <div v-if="mode === 'gestion-location'" class="game-actions">
                <RouterLink :to="`/modifierLocation/${jeu.Id}`" class="btn-modifier" title="Modifier">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
                    </svg>
                </RouterLink>
                <RouterLink :to="`/supprimerLocation/${jeu.Id}`" class="btn-supprimer" title="Supprimer">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="3 6 5 6 21 6" />
                        <path d="M19 6l-1 14H6L5 6" />
                        <path d="M10 11v6" />
...
const props = defineProps({
    ...
    mode: {
        type: String,
        default: 'achat',
        validator: (v) => ['achat', 'gestion', 'location', 'gestion-location'].includes(v)
    }
})
