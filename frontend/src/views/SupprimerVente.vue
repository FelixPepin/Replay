  ...
  <main>
    <div class="container mt-2">
      <div class="row justify-content-center">
        <div class="col-md-6">
          <h1 class="mb-4 text-center">Supprimer une vente</h1>
          <div v-if="auth.userId === vendeurId">
            ...
            <form
              ...
              novalidate
            >
              <button type="submit" class="btn btn-danger w-100 mb-3">Supprimer le jeu</button>
            </form>
          </div>
          <div v-else>
...
async function supprimerVente() {
  try {
    const reponse = await fetch(`/api/supprimerVente/${idVente}`, {
      method: 'POST',
    })
