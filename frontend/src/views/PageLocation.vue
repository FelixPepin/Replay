    ...
    <main class="store-page">
        ...
        <div class="store-body">
            ...
            <aside class="sidebar-filters">
                ...
                <div class="filter-group">
                    <label class="filter-label">Début disponibilité</label>
                    <input v-model="filtreDateDebut" type="date" class="filter-input" />
                </div>

                <div class="filter-group">
                    <label class="filter-label">Fin disponibilité</label>
                    <input v-model="filtreDateFin" type="date" class="filter-input" />
                </div>

                <div class="filter-group">
                    <label class="filter-label">Fourchette de prix</label>
                    <div class="prix-range">
                        <input v-model.number="filtrePrixMin" type="number" min="0" class="filter-input"
                            placeholder="Min $" @input="limiterDecimales($event, 'filtrePrixMin')" />
                        <span class="prix-sep">—</span>
                        <input v-model.number="filtrePrixMax" type="number" min="0" class="filter-input"
                            placeholder="Max $" @input="limiterDecimales($event, 'filtrePrixMax')" />
                    </div>
                </div>
            </aside>

            <section class="games-grid-wrap">
                <div v-if="jeuxTriees.length === 0" class="état-vide">
                ...
                <div v-else class="games-grid">
                    <JeuCard v-for="jeu in jeuxTriees" :key="jeu.Id" :jeu="jeu" mode="location" />
                </div>
            </section>
